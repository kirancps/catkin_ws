...
(cl:defmethod cl:initialize-instance :after ((m <Encoders>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Encoders)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ros_arduino_msgs-msg:<Encoders> is deprecated: use ros_arduino_msgs-msg:Encoders instead.")))
...
(cl:defmethod left-val ((m <Encoders>))
...
(cl:defmethod right-val ((m <Encoders>))
